...
namespace Client
{
    public partial class Editor_Map : DarkForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            Label11 = new cmbLabel();
            Label10 = new cmbLabel();
            ...
            Label12 = new cmbLabel();
            tpEvents = new TabPage();
            lblPasteMode = new cmbLabel();
            lblCopyMode = new cmbLabel();
            btnPasteEvent = new DarkButton();
            Label16 = new cmbLabel();
            btnCopyEvent = new DarkButton();
            Label15 = new cmbLabel();
            Label13 = new cmbLabel();
            ...
            lblMapAlpha = new cmbLabel();
            lblMapBlue = new cmbLabel();
            lblMapGreen = new cmbLabel();
            lblMapRed = new cmbLabel();
            ...
            lblFogOpacity = new cmbLabel();
            scrlFogSpeed = new DarkScrollBar();
            lblFogSpeed = new cmbLabel();
            scrlIntensity = new DarkScrollBar();
            lblIntensity = new cmbLabel();
        ...
        internal cmbLabel lblMapWarpY;
        internal cmbLabel lblMapWarpX;
        internal cmbLabel lblMapWarpMap;
        ...
        internal cmbLabel Label5;
        internal DarkTextBox txtBootY;
        internal cmbLabel Label3;
        internal DarkTextBox txtBootX;
        internal cmbLabel Label4;
        ...
        internal cmbLabel Label11;
        internal cmbLabel Label10;
        internal DarkComboBox cmbLayers;
        internal cmbLabel Label9;
        ...
        internal cmbLabel Label16;
        internal DarkButton btnCopyEvent;
        internal cmbLabel Label15;
        internal cmbLabel lblPasteMode;
        internal cmbLabel lblCopyMode;
        internal TabPage tpEffects;
        internal DarkGroupBox GroupBox3;
        internal DarkCheckBox chkTint;
        internal cmbLabel lblMapAlpha;
        internal cmbLabel lblMapBlue;
        internal cmbLabel lblMapGreen;
        internal cmbLabel lblMapRed;
